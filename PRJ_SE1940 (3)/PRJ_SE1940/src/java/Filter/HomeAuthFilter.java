 ...
 * @author ADMIN
 */
//Các trang web có url để phân quyền
...
public class HomeAuthFilter implements Filter {
    ...
    public HomeAuthFilter() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("HomeAuthFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("HomeAuthFilter:DoAfterProcessing");
        }
    ...
    boolean allowedForRole3 = isLoginPage || isRegisterPage || isLogoutPage  || isUserApplicationPage;
    // Các trang mà roleId = 1 và 2 được phép vào
    boolean allowedForRole1And2 = allowedForRole3  || isManagementPage || isStatisticPage;
    ...
    if (loggedIn) {
        ...
        if (roleId == 3 && !allowedForRole3) {
            ...
            httpResponse.sendRedirect(httpRequest.getContextPath() + "/userApplicationManagement");
            return;
        } 
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("HomeAuthFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("HomeAuthFilter()");
        }
        StringBuffer sb = new StringBuffer("HomeAuthFilter(");
