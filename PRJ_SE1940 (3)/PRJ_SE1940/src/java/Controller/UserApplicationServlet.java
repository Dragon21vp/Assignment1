...
public class UserApplicationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action != null && action.equalsIgnoreCase("add")) {
            ...
            request.getRequestDispatcher("USER_ApplicationAdd.jsp").forward(request, response);
            return;
...
//            System.out.println("===== Servlet received a POST request =====");
//            System.out.println("APPLYCATION === ID: "+request.getParameter("applicationId") );
            int applicationId = Integer.parseInt(request.getParameter("applicationId"));
            String startDateStr = request.getParameter("startDate");
            String endDateStr = request.getParameter("endDate");
            String title = request.getParameter("title");
