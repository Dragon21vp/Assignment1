...
<html lang="en">
    ...
    <head>
        <title>Chi tiết đơn hàng | Quản trị Admin | Watch-Pro</title>
                            ...
                            <table class="table table-hover table-bordered" id="sampleTable">
                                ...
                                <tbody>
                                    <c:forEach items="${detail}" var="d">
                                        <tr>
                                            <td><img src="img//${d.getProductById(d.getProductId()).getThumbnail()}" alt="" width="100px;"></td>
                                            <td>${d.getProductById(d.getProductId()).getId()}</td>
                                            <td>${d.getProductById(d.getProductId()).getName()}</td>
                                            <td>${d.getProductById(d.getProductId()).getCategory().getCategoryName()}</td>
